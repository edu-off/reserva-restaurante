...
public class BuscaRestaurantesPorCulinariaTest {
    ...
    @Nested
    public class ValidacaoBuscaRestaurantesPorCulinaria {
        ...
        public void deveRetornarRestaurantesCorretamente() {
            ...
            when(restauranteGateway.buscaRestaurantesPorCulinaria("culinaria", pageable)).thenReturn(pages);
            Page<Restaurante> pagesRetrieved = buscaRestaurantesPorCulinaria.execute("culinaria", pageable);
