...
public class BuscaReservaPorClientePeriodoTest {
    ...
    public class ValidacaoBuscaReservaPorClientePeriodo {
        ...
        public void deveBuscarReservasCorretamente() {
            ...
            when(reservaGateway.buscaReservasPorClientePeriodo(email, dateTime, dateTime, pageable)).thenReturn(reservasMocked);
            Page<Reserva> reservasReturned = buscaReservasPorClientePeriodo.execute(email, dateTime, dateTime, pageable);
