...
public class BuscaReservaPorRestauranteTest {
    ...
    @Nested
    public class ValidacaoBuscaReservaPorRestaurante {
        ...
        public void deveBuscarReservasCorretamente() {
            ...
            when(reservaGateway.buscaReservasPorRestaurante(id, pageable)).thenReturn(reservasMocked);
            Page<Reserva> reservasReturned = buscaReservasPorRestaurante.execute(id, pageable);
