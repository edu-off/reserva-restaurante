...
public class BuscaReservaPorRestaurantePeriodoTest {
    ...
    @Nested
    public class ValidacaoBuscaReservaPorRestaurantePeriodo {
        ...
        public void deveBuscarReservasCorretamente() {
            ...
            when(reservaGateway.buscaReservasPorRestaurantePeriodo(id, dateTime, dateTime, pageable)).thenReturn(reservasMocked);
            Page<Reserva> reservasReturned = buscaReservasPorRestaurantePeriodo.execute(id, dateTime, dateTime, pageable);
